...
export default function StaffPage() {
  ...
  return (<div className="space-y-4">
    ...
    {loadError && <div role="alert" className="flex items-center justify-between gap-4 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700"><span>{loadError}</span><Button variant="secondary" size="sm" onClick={fetchStaff}>Réessayer</Button></div>}
