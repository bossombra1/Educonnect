...
export default function ScheduledMessagesPage() {
  ...
  const columns: Column<ScheduledRow>[] = [
    ...
    { key: 'recipients', header: 'Destinataires', render: () => <span className="text-xs text-slate-500">À la programmation</span> },
