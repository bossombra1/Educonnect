...
export default function AdminLayout() {
  ...
  return (
    <div className="flex h-screen bg-[#F0F4FF]">
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-40 flex w-64 flex-col bg-[#1E293B] transition-transform duration-300 lg:static lg:translate-x-0',
      ...
      >
        ...
        <div className="flex h-16 items-center gap-3 px-6">
          ...
          <div>
            <h1 className="text-base font-bold text-white">EduConnect</h1>
