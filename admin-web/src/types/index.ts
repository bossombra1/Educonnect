...
export interface Message {
  id: string; title?: string; content: string; type: MessageType; priority: MessagePriority; senderId: string; sender?: User;
  recipients: MessageRecipient[]; attachments: MessageAttachment[]; status: MessageStatus; scheduledAt?: string; sentAt?: string;
  createdAt: string; updatedAt: string; readCount: number; deliveryCount: number; totalRecipients: number;
}
